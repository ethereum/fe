...
* [Specification (WIP)](spec/index.md)
    ...
    * [Items](spec/items/index.md)
        ...
        * [Functions](spec/items/functions/index.md)
          * [Context](spec/items/functions/context.md)
          * [Self](spec/items/functions/self.md)
