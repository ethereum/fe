...
fn main() {
    ...
    let z = x.bar;
        ...
        assert!(
            result.is_empty(),
            ":: in Foo::new should not trigger goto, but got {:?}",
            result
        );
        ...
        assert!(
            result.is_empty(),
            "( should not trigger goto, but got {:?}",
            result
        );
        ...
        assert!(
            result.is_empty(),
            ": in field assignment should not trigger goto, but got {:?}",
            result
        );
        ...
        assert!(
            result.is_empty(),
            ". in field access should not trigger goto, but got {:?}",
            result
        );
        ...
        assert!(
            result.is_empty(),
            "-> arrow should not trigger goto, but got {:?}",
            result
        );
...
fn main() {
    let b = Bar { x: 1 };
        ...
        assert!(
            !result.is_empty(),
            "Middle of Bar identifier should trigger goto"
        );
        ...
        assert!(
            !result.is_empty(),
            "End of Bar identifier should trigger goto"
        );
    }
}
